...
# libnvram source are no longer assembled here -- they build themselves via
# their own flakes and penguin stages them directly. This dist is just the
# debugging-tool closures + drop-in sysroots.
